...
/**
 * print_integer - Print integer function
 * @args: arguments List
 * @buffer: Buffer character array
 * @flags: active flags caculator
 * @width: Get width parameter.
 * @precision: specification Precisioner
 * @size: integer specifies the length
 * Return: Number of characters printed
 */
